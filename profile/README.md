...
서비스 주제를 고민하며 저희가 가장 먼저 주목한 것은 스스로 반복해서 겪어 온 문제였습니다. 글을 대신 작성해 주는 AI 서비스는 많지만, 학생이 직접 작성한 리포트를 제출 전에 종합적으로 점검해 주는 도구는 부족했습니다. 저희 역시 과제를 제출할 때마다 분량, 문서 구조, 인용 표기, 참고문헌 등을 여러 서비스에서 각각 확인해야 했습니다.
